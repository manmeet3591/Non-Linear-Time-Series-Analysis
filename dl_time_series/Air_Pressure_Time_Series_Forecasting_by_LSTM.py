{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Epoch 1/20\n",
      "35057/35057 [==============================] - 51s 1ms/step - loss: 0.0312 - val_loss: 0.0143\n",
      "Epoch 2/20\n",
      "35057/35057 [==============================] - 43s 1ms/step - loss: 0.0192 - val_loss: 0.0113\n",
      "Epoch 3/20\n",
      "35057/35057 [==============================] - 44s 1ms/step - loss: 0.0154 - val_loss: 0.0092\n",
      "Epoch 4/20\n",
      "35057/35057 [==============================] - 43s 1ms/step - loss: 0.0142 - val_loss: 0.0107\n",
      "Epoch 5/20\n",
      "35057/35057 [==============================] - 44s 1ms/step - loss: 0.0139 - val_loss: 0.0095\n",
      "Epoch 6/20\n",
      "35057/35057 [==============================] - 44s 1ms/step - loss: 0.0137 - val_loss: 0.0115\n",
      "Epoch 7/20\n",
      "35057/35057 [==============================] - 44s 1ms/step - loss: 0.0136 - val_loss: 0.0102\n",
      "Epoch 8/20\n",
      "35057/35057 [==============================] - 45s 1ms/step - loss: 0.0135 - val_loss: 0.0087\n",
      "Epoch 9/20\n",
      "35057/35057 [==============================] - 42s 1ms/step - loss: 0.0134 - val_loss: 0.0092\n",
      "Epoch 10/20\n",
      "35057/35057 [==============================] - 41s 1ms/step - loss: 0.0134 - val_loss: 0.0114\n",
      "Epoch 11/20\n",
      "35057/35057 [==============================] - 41s 1ms/step - loss: 0.0134 - val_loss: 0.0097\n",
      "Epoch 12/20\n",
      "35057/35057 [==============================] - 42s 1ms/step - loss: 0.0133 - val_loss: 0.0086\n",
      "Epoch 13/20\n",
      "35057/35057 [==============================] - 44s 1ms/step - loss: 0.0133 - val_loss: 0.0090\n",
      "Epoch 14/20\n",
      "35057/35057 [==============================] - 41s 1ms/step - loss: 0.0133 - val_loss: 0.0105\n",
      "Epoch 15/20\n",
      "35057/35057 [==============================] - 46s 1ms/step - loss: 0.0132 - val_loss: 0.0107\n",
      "Epoch 16/20\n",
      "35057/35057 [==============================] - 43s 1ms/step - loss: 0.0132 - val_loss: 0.0106\n",
      "Epoch 17/20\n",
      "35057/35057 [==============================] - 43s 1ms/step - loss: 0.0133 - val_loss: 0.0101\n",
      "Epoch 18/20\n",
      "35057/35057 [==============================] - 45s 1ms/step - loss: 0.0133 - val_loss: 0.0090\n",
      "Epoch 19/20\n",
      "35057/35057 [==============================] - 43s 1ms/step - loss: 0.0132 - val_loss: 0.0092\n",
      "Epoch 20/20\n",
      "35057/35057 [==============================] - 42s 1ms/step - loss: 0.0132 - val_loss: 0.0087\n"
     ]
    },
    {
     "data": {
      "text/plain": [
       "<keras.callbacks.History at 0x7f8778400b70>"
      ]
     },
     "execution_count": 25,
     "metadata": {},
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "best_model = load_model(os.path.join('keras_models', 'PRSA_data_Air_Pressure_LSTM_weights.12-0.0086.hdf5'))\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "R-squared on validation set of the original air pressure: 0.9958380712906134\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "outputs": [
    ...
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
       "<Figure size 396x396 with 1 Axes>"
      ]
     },
